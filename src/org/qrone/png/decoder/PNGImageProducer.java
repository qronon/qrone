...
public class PNGImageProducer implements Runnable {
    ...
    private void handlebKGD() throws IOException {
        inputStream.skipBytes(chunkLength);
    }
    ...
    private void handleChunk() throws IOException {
        ...
        */
        ...
        switch (chunkType) {
          ...
          default:
        	  /*
        	  char c1 = (char) ((chunkType & 0xFF000000) >>> 24);
          	  char c2 = (char) ((chunkType & 0xFF0000) >>> 16);
          	  char c3 = (char) ((chunkType & 0xFF00) >>> 8);
          	  char c4 = (char) ((chunkType & 0xFF));
          	  
          	  
              System.err.println("unrecognized chunk type '" +
                                  String.valueOf(c1) + String.valueOf(c2) 
                                + String.valueOf(c3) + String.valueOf(c4) + "' skipping");
    ...
    */
    ...
    public void startProductionSync(ImageConsumer ic) {
        addConsumer(ic);
        run();
    }
}
