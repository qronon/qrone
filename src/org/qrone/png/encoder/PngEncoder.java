...
public class PngEncoder extends Object {
    ...
    /** The image. */
    protected PNGMemoryImage image;
     ...
     * @see java.awt.Image
     */
    public PngEncoder(PNGMemoryImage image) {
     ...
     * @see java.awt.Image
     */
    public PngEncoder(PNGMemoryImage image, boolean encodeAlpha) {
     ...
     * @see java.awt.Image
     */
    public PngEncoder(PNGMemoryImage image, boolean encodeAlpha, int whichFilter) {
     ...
     * @see java.awt.Image
     */
    public PngEncoder(PNGMemoryImage image, boolean encodeAlpha, int whichFilter, int compLevel) {
        this.image = image;
     ...
     */
    public void setImage(PNGMemoryImage image) {
        this.image = image;
        pngBytes = null;
    }
    ...
    protected boolean writeImageData() {
        ...
        try {
            while (rowsLeft > 0) {
                ...
                if ((pg.getStatus() & PixelGrabber.ABORT) != 0) {
